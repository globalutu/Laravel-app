...
@section('content')
    ...
    <!-- Modal Bootstrap pour demander à l'utilisateur de se connecter -->
    @if (!Auth::check())
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="loginAlertModalLabel">Connexion requise</h5>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            @if (!Auth::check())
                // Afficher le modal si l'utilisateur n'est pas connecté
